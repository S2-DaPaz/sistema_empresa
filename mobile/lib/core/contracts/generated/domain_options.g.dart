...
const Map<String, List<DomainOption>> kDomainOptions = {
  'taskStatus': [
    ...
    DomainOption(value: 'concluida', label: 'Concluida'),
  ],
  'taskPriority': [
    DomainOption(value: 'alta', label: 'Alta'),
    DomainOption(value: 'media', label: 'Media'),
  ...
  'signatureMode': [
    ...
    DomainOption(value: 'tech', label: 'Tecnico'),
    DomainOption(value: 'both', label: 'Cliente e Tecnico'),
  ],
  'signatureScope': [
    DomainOption(value: 'all_pages', label: 'Todas as paginas'),
